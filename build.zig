...
pub fn build(b: *std.Build) void {
...

    {
        ...
        example_hello_world.addAnonymousModule("pass", .{ .source_file = .{ .path = "src/pass.zig" } });
...

    {
        ...
        example_https_webserver.addAnonymousModule("pass", .{ .source_file = .{ .path = "src/pass.zig" } });
